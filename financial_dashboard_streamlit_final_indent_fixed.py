...
##### 尋找最後 NAN值的位置
# last_nan_index_MACD = KBar_df_MACD_rev = KBar_df['MACD'][::-1]
macd_na_mask = KBar_df_MACD_rev.isna()
last_nan_index_MACD = KBar_df_MACD_rev.index[macd_na_mask][0] if macd_na_mask.any() else None
...
if choice_strategy == choices_strategies[0]:
    ...
    KBar_df['RSI'] = ta.rsi(KBar_df['close'], length=RSIPeriod)
